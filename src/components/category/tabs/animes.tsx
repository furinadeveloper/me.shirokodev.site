...
import SlimeDattaKen from "@/images/SlimeDattaKen.jpg";
import Arifureta from "@/images/Arifureta.jpg"
import KagenoJitsuryokusha from "@/images/KagenoJitsuryokusha.jpg";
import MeitanteiConan from "@/images/MeitanteiConan.jpg";
import TatenoYuusha from "@/images/TatenoYuusha.jpg";
import YoukosoJitsuryoku from "@/images/YoukosoJitsuryoku.jpg";
import OshinoKo from "@/images/OshinoKo.jpg";
import SeishunButa from "@/images/SeishunButa.jpg";
import ReZero from "@/images/Re:Zero.jpg";
import LycorisRecoil from "@/images/LycorisRecoil.jpg";
import { NextFont } from "next/dist/compiled/@next/font";
export default function Animes({ font }: { font: NextFont }) {
  return (
    <section>
      <div className={`${font.className} fade-in mt-10 max-w-[896px]`}>
        {[
          {
            name: "Sword Art Online: Alicization",
            description: "Kirito awakens in a vast, fantastical forest filled with towering trees.",
          ...
          {
            name: "Oshi no Ko",
            description: "Idols and die-hard fans are reincarnated as her children",
            image: OshinoKo,
          ...
          },
          {
            ...
            description: "The tragedy of Subaru's ability to die and come back to life and his love for Emilia.",
            image: ReZero,
            url: "https://anilist.co/manga/85737/ReZero-kara-Hajimeru-Isekai-Seikatsu/",
          },
          {
            name: "Lycoris Recoil",
            description: "Tells about the great feelings and abilities of two young girls.",
            image: LycorisRecoil,
